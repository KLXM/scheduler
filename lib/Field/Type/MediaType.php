...
final class MediaType extends AbstractType
{
    ...
    public function options(): array
    {
        return [
            ...
            ['name' => 'category', 'label' => I18n::t('fieldopt_media_category'), 'type' => 'number'],
    ...
    {
        if (!class_exists(\rex_var_media::class)) {
        ...
        return \rex_var_media::getWidget($context->inputId, $context->inputName, $context->stringValue(), $args);
    }
