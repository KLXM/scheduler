<?php
/**
 * Scheduler-Termine - UIkit Template
 *
...
if (!class_exists(SchedulerRenderer::class)) {
    return;
}

$result = SchedulerRenderer::fetch($elementData);
...
$rows = SchedulerRenderer::buildSeparatedRows((array) $items, $groupBy);
...
if ($error !== null) {
    ...
    foreach ($rows as $row) {
        ...
        $dateStr = SchedulerRenderer::formatDate($it);
